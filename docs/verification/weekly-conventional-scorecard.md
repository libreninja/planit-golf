...
Only the expanded card is redesigned: aligned Hole, Par and actual Score rows, a round-length-aware actual-stroke Total (Out/In subtotals plus a full-round Total for 18 holes), and the selected competition's aggregate above. Circles/squares encode selected-mode authoritative performance; double outlines cover eagle-or-better and double-bogey-or-worse. Net score cells carry explicit handicap dots immediately beside the actual score, outside its circle or square; multiple dots stack vertically; unknown allocation uses a small question mark. Nine columns fit a phone without horizontal scrolling. Gross shows no dots or Net aggregate. Partial cards retain nine holes and existing THRU semantics.
