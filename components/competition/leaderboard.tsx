    ...
    <div className="space-y-3">
      ...
      <div className="divide-y divide-border">
        {leaderboard.entries.map((e) => {
          ...
          const participation = teeSheet ? weeklyParticipationForCard(card, teeSheet) : null;
          const participationLabel = participation && !['live', 'finished'].includes(participation.kind)
            ? participation.label
            : null;
          return (
            <ScorecardRow
