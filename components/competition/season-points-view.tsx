        ...
        <div className="max-h-[60vh] overflow-y-auto">
          ...
          <div className="divide-y divide-border">
            {rows.map((r) => {
              ...
              return (
                <div key={r.member_card_id} className="grid grid-cols-[2rem_minmax(0,1fr)_4.5rem_2.5rem_3rem] gap-1 px-2 py-1.5 text-sm sm:grid-cols-[3rem_minmax(0,1fr)_6rem_5rem_5rem] sm:gap-2 sm:px-3 lg:grid-cols-[4rem_minmax(16rem,1fr)_7rem_6rem_6rem]">
